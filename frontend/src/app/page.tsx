...
import PublicNavbar from "@/components/PublicNavbar"; // Importiere die neue PublicNavbar

export default function Home() {
  return (
    <div>
      <PublicNavbar /> {/* Füge die PublicNavbar hier ein */}
      <main style={{ paddingTop: "80px" }}> {/* Füge Padding hinzu, um Platz für die fixe Navbar zu schaffen */}
